<html lang="en">
  <head>
    ...
    <title>Online Quiz Certificate </title>
  </head>
  <body>
  <br>
  &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp <a href="userhome.php" class="btn btn-danger">Back TO Home Page</a>
    <center>
      <br><br>
      <h3> Online Quiz Certificate </h3>
	...
	$email = $_SESSION['email'];
      //if (isset($_POST['download'])){
        ...
        $occupation = strtoupper('Bangalore Institute Of Technology');
        if ($occupation) {
        ...
        if ($name == "" || $occupation == "") {
         ...
         //uploading to the database 
           ...
           $check = mysqli_query($conn,"UPDATE users SET certi = '$dst_db' WHERE email = $email ");  // executing insert query
 ...
 ?>
        ...
        <a href="<?php echo $output; ?>" class="btn btn-success">Download My Quiz Certificate</a>
        <br><br>
<?php 
        }
      }
     ...
     ?>
      ...
      <footer>  
          <center><p>Built with &#10084; by <a href="https://rohitbit.tech">Rohit Kumar</a></p></center>
      </footer>
