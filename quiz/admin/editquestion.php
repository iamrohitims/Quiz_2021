	...
	<body>
		<header>
			<div class="container">
				...
				<a href="admin/add.php" class="start">Add Question</a>
				<a href="admin/allquestions.php" class="start">All Questions</a>
				<a href="admin/feedback.php" class="start">Feedback</a>
				<a href="admin/exit.php" class="start">Logout</a>
